...
<body>
  <div class="jumbotron" style="background-color:white">
     <h1 class="text-center">Welcome to</h1>
      ...
      <h2 class="text-center">Welcome to Mid-hxn 07 on behalf of DevOps Academy , Now i make it as webhook , Attempt 1 , Attempt 04..  Midhun is so confide nt guy... , 5th one click deployment. And addede ci-cd piepiline also...with slcak... 5/7/2025 ..CI-CD done..</h2>
